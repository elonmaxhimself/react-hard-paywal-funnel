...
export function LoaderStep({
    ...
    const mainLoader = useLoader(mainLoaderProps.initialCountdown, mainLoaderProps.maxCountdown, mainLoaderProps.speed);
        ...
        <StepWrapper>
            <div className="max-w-[450px] flex-1 h-full w-full mx-auto flex flex-col items-center justify-center">
                <div className="w-full flex-1 sm:flex-none flex flex-col items-center sm:justify-center mb-[30px] sm:mb-[70px]">
                    ...
                    <div className={'relative w-full h-auto aspect-[360/485] rounded-[10px] overflow-hidden mb-5'}>
                        ...
                        >
                            <div className={'w-full absolute top-[50%] left-[50%] -translate-[50%]'}>
                                <p
                                    className={
                                ...
                                <p className={'text-white text-base font-medium text-center'}>
                                    <Trans i18nKey="funnel.loaderStep.subtitle" components={{ br: <br /> }} />
                                </p>
                            </div>
                        </div>
                    ...
                    <div className={'w-full flex flex-col gap-[10px]'}>
                        {LOADERS.map(({ label, key }) => (
                            <div className={'w-full'} key={key}>
                                <div className={'text-white text-sm flex items-center justify-between mb-[5px]'}>
                                    <span>{label}</span>
