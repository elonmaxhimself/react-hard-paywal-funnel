...
const buttonVariants = cva(
    "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
    {
        variants: {
            variant: {
                default:
                    'text-primary-foreground shadow-xs hover:bg-primary/90 bg-primary-gradient border border-sm border-transparent rounded-[10px]',
                destructive:
                    'bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60',
                outline:
                    'border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
                secondary: 'bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80',
                ghost: 'ghost-button text-white',
                unstyled: '',
                link: 'text-primary underline-offset-4 hover:underline',
                pink: 'gradient-pink',
                lose: ' bg-white/5 text-white/70 hover:text-white',
            },
            size: {
                default: 'h-[45px] px-4 py-2 has-[>svg]:px-3 text-[16px]',
                sm: 'h-[45px] rounded-md gap-1.5 px-3 has-[>svg]:px-2.5',
                lg: 'h-[68px] rounded-md px-6 has-[>svg]:px-4',
                icon: 'size-9',
                content: 'w-fit h-auto',
                bold: 'text-base font-bold h-[45px]',
            },
        },
        defaultVariants: {
            variant: 'default',
